...
class FairnessMetrics():
    def __init__(self, y_pred, y_actual, x_test, sensitive_attr):
        ...
        self.indices_protected = x_test.index[x_test[sensitive_attr] == 1].tolist()
        self.indices_unprotected = x_test.index[x_test[sensitive_attr] == 0].tolist()
        ...
        self.cm_prot = confusion_matrix(self.y_pred_protected, self.y_actual_protected)
        self.cm_unprot = confusion_matrix(self.y_pred_unprotected, self.y_actual_unprotected)
...
class CausalDiscrimination():
    ...
    def compute_causal_discrimination(self):
        ...
        """
        # Create new test set:
        x_test_swapped_sensitive_attr = self.x_test
